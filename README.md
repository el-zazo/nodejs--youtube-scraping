...
```bash
npm install @elzazo/youtube-scraping
```
...
```javascript
const { Video } = require("@elzazo/youtube-scraping");
...
```javascript
const { Playlist } = require("@elzazo/youtube-scraping");
...
```javascript
const { YoutubeSearch } = require("@elzazo/youtube-scraping");
